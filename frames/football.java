...
public class football extends JFrame implements ActionListener {
	...
	public football() {
		...
		jlbl1 = new JLabel("Adidas Jabulani ");
		...
		jlbl3 = new JLabel("Adidas Champions League");
		...
		jlbl5 = new JLabel("Adidas Al Rihla");
