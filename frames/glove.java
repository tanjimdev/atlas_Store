...
public class glove extends JFrame implements ActionListener{
	JPanel panel;
	...
	public glove() {
		...
		jlbl1 = new JLabel("Adidas ADZ13 Gloves");
		jlbl1.setBounds(20,340,200,50);
		...
		jlbl3 = new JLabel("Nike ProMatch Gloves");
		...
		jlbl5 = new JLabel("Adidas Predator Gloves");
