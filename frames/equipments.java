...
public class equipments extends JFrame implements ActionListener{
	...
	public equipments() {
		...
		chose =new JLabel("Chose your equipments");
		...
		catButton = new JButton("Equipments");
...
//		img2 = new ImageIcon("cart.png");
		img3 = new ImageIcon("Images/ball.png");
		img4 = new ImageIcon("Images/boot.png");
		img5 = new ImageIcon("Images/gloves.png");
