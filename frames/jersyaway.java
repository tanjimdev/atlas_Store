...
public class jersyaway extends JFrame implements ActionListener {
	JPanel panel;
	...
	public jersyaway() {
		...
		catButton = new JButton("Away Kit");
		...
		jlbl1 = new JLabel("Juventus Away Kit");
		...
		jlbl3 = new JLabel("Liverpool Away Kit");
		...
		jlbl5 = new JLabel("Inter Miami Away Kit");
...
//		img2 = new ImageIcon("cart.png");
		// img3 = new ImageIcon("img1.png");
		// img4 = new ImageIcon("img2.png");
		// img5 = new ImageIcon("img3.png");

		img1 = new ImageIcon("Images/juventus.png");
		imagelabel = new JLabel(img1);
		imagelabel.setBounds(20,50,300,300);
		panel.add(imagelabel);

		img2 = new ImageIcon("Images/liverpool.png");
		imagelabel = new JLabel(img2);
		imagelabel.setBounds(340,50,300,300);
		panel.add(imagelabel);

		img3 = new ImageIcon("Images/miami.png");
