...
public class jersythird extends JFrame implements ActionListener {
	JPanel panel;
	...
	public jersythird() {
		...
		jlbl1 = new JLabel("Barcelona Third Kit");
		...
		jlbl3 = new JLabel("Real Madrid Third Kit");
		...
		jlbl5 = new JLabel("Bayern Munich Third Kit");
